...
Supported: `claude-opus-45`, `grok-41-fast`, `kimi-k2-thinking`, `gemini-3-pro-preview`, `qwen3-235b-a22b-thinking-2507`, `qwen3-4b`, `deepseek-ai-DeepSeek-R1`
...
| --------------- | ---------- | ---------- | ------------- |
| Claude Opus 4.5 | ~4,000     | 5 min      | 90%           |
...
| claude-opus-45    | $6.00 | $30.00 | Anonymized |
